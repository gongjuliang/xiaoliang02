...
func TestRouterServesEmbeddedFrontend(t *testing.T) {
	...
	assertContainsAll(t, index, "小良内网穿透-客户端", "客户端控制台", "sessionStorage", "natt_client_active_view")
	...
	assertContainsAll(t, loginPage, "小良内网穿透-客户端", "agree_terms", "已阅读并同意", "/agreement.html", "captchaImage", "captchaRefresh", "captcha_code", "/static/js/sm2.js")
