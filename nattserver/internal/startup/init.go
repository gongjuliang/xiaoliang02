...
</html>`, selectedAttr(cfg.App.Environment, "development"), selectedAttr(cfg.App.Environment, "production"), cfg.HTTP.Port, cfg.Protocol.ControlPort, cfg.Protocol.DataPort, html.EscapeString(cfg.Database.Path))
}
